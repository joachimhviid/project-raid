<template>
  <div class="bg-white bg-opacity-80 dark:bg-rblue dark:bg-opacity-70 rounded-lg py-6 px-8 space-y-7">
    ...
    <button class="flex items-center space-x-4">
      ...
      <span class="text-rblue dark:text-white/90 font-rtext text-2xl">GuildoBuildoEU</span>
    </button>
    <button class="flex items-center space-x-4">
    ...
    <button class="flex items-center space-x-4">
      ...
      <span class="text-rblue dark:text-white/90 font-rtext text-2xl">discord.gg/gDerFt</span>
    </button>
  </div>
</template>
